...
/**
 * 随机函数 Math.random() [0,1) 等概率返回
 * y=x -> y=x^2  任意的x，x属于[0,1)，[0,x)范围上的数出现概率由原来的x调整成x平方。方法：xToXPower2
 ...
 *条件：f():1-5    目标：g():1-7
 * f1()=f()
 * f2():把f()改造成0-1等概率发生器--> 随机到1，2是0. 随机到4，5是1. 3重来
 * f3(): 1-7又是 （0-6）+1  三个二进制数：f2,f2,f2  就是0-7等概率
 * f4():遇7重做，等概率返回(0-6)
 * g() = f4()+1
 *
 *例题：
 * f():3-19     g():17-56
 * f1():01发生器 3-10  11  12-19
 * g()=(0.39)+17
 * 六个二进制 0-63 ______ f1,f1,f1,f1,f1,f1
 * 扔到40-63重新做，只要0-39
 *
 * 例题：
 * f():0,1 概率是p,1-p
